...
# meta pic: https://likebot.pp.ua/
# meta banner: https://likebot.pp.ua/vtt.jpg
...
class VoicyMod(loader.Module):
    """Recognize voice messages and audio messages"""
    ...
    strings_ru = {
        ...
        "_cls_doc": "Распознает только голосовые сообщения и аудио",
    ...
    async def recognize(self, message: Message):
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                if message.video:
                    audio_data = self.extract_audio_from_video(data)
                else:
                    audio_data = data
    ...
    def extract_audio_from_video(self, video_data):
        """Extract audio from video without using ffmpeg."""
        # This method assumes that the video is already in a suitable format.
        # If necessary, you can use libraries like moviepy or other alternatives.
        try:
